...
$id_admin = [
    ...
    'options' => $admin,
    'class' => 'form-control',
    'selected' => $laporan->id_admin
];

$tanggal_bergabung = [
    'name' => 'tanggal_bergabung',
    'id' => 'tanggal_bergabung',
    'value' => $laporan->tanggal_bergabung,
    'class' => 'form-control',
    'type' => 'date'
];
...
<div class="card text-dark bg-light mb-3 mt-4">
  ...
  <div class="card-body"> 
    ...
    <!-- Form Tambah Pasien -->
    <?= form_open('admin/laporan_pengunjung/find/' . $laporan->id_transaksi) ?>
