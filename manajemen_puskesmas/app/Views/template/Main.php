    ...
    <div class="container mt-5 pr-5">
        <div class="row  align-items-center text-center text-md-left">
            ...
            <div class="col-md-6 pl-md-5 content" data-aos="fade-left">
                ...
                <a href="<?= base_url('/login_pengguna') ?>"><button class="button">Belajar Lebih</button></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row  align-items-center">
            <div class="col-md-6 content" data-aos="fade-right">
                ...
                <div class="box">
                    ...
                    <a style="margin-left: 200px;" href="<?= base_url('/user/dokter') ?>"><button class="button">Cek Dokter</button></a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-10" data-aos="flip-down">
                <form action="<?= base_url('/user/User_register/insert') ?>" method="post">
                    <div class="inputBox">
