...
<body>
    ...
    <header>
        <div class="container">
            ...
            <nav class="nav">
                <ul>
                    <li><a href="<?= base_url('/user/home_user') ?>">Home</a></li>
                    <li><a href="<?= base_url('user/pendaftaran') ?>">Pendaftaran</a></li>
                    <li><a href="<?= base_url('user/jadwal') ?>">Jadwal</a></li>
                    <li><a href="<?= base_url('user/transaksi') ?>">Transaksi</a></li>
                    <li><a href="<?= base_url('user/beli_obat') ?>">Beli Obat</a></li>
                    <li><a href="<?= base_url('user/dokter_user') ?>">Dokter</a></li>
                    <li><a href="<?= base_url('user/obat_user') ?>">Obat</a></li>
                    <li><a href="<?= base_url('user/ruang_user') ?>">Ruang</a></li>
                    <li><a href="<?= base_url('user/Login_User/logout') ?>">Logout</a></li>
                </ul>
            </nav>
