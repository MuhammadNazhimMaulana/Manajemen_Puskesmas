...
$id = [
    ...
    'options' => $daftar_user,
    'class' => 'form-control',
    'selected' => $pendaftar->id
];

$sakit = [
    'name' => 'sakit',
    'id' => 'sakit',
    'value' => $pendaftar->sakit,
    'class' => 'form-control'
];
...
<div class="col-8">
  <div class="card text-dark bg-light mb-3 mt-4">
    <div class="card-header text-center">Form Update Data Pendaftaran</div>
        <div class="card-body"> 
            <div class="row mt-3">
                <!-- Form Tambah Ruang -->
                <?= form_open('admin/pendaftaran/find/' . $pendaftar->id_daftar) ?>
